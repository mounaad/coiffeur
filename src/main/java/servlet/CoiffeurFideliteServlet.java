...
import model.Client;
import model.Fidelite;
import model.User;


/**
 * Servlet implementation class CoiffeurFideliteServlet
 */
@WebServlet("/coiffeur/fidelite")
public class CoiffeurFideliteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CoiffeurFideliteServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       ...
       request.getRequestDispatcher("/coiffeur/fidelite.jsp").forward(request, response);
