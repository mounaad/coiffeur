    ...
    <div class="dashboard-layout">
        ...
        <main class="main-content">
            ...
            <div class="form-section">
                <h3 class="section-title">Nouveau Client</h3>
                ...
                <div class="form-container">
                    ...
                    <form method="post" action="${pageContext.request.contextPath}/admin/clients" class="form-single-column">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="nom" name="nom" class="form-control" required placeholder="Entrez le nom du client">
                        </div>
                        
                        <div class="form-group">
                            <label for="prenom">Prénom :</label>
                            <input type="text" id="prenom" name="prenom" class="form-control" required placeholder="Entrez le prénom du client">
                        </div>
